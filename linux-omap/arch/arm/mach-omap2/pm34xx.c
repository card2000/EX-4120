 ...
 * revised for wakeup interrupt control - Keiichi Matsuhashi 
 * 
...
//	} while (irqstatus_mpu);
	} while ((irqstatus_mpu)&&(i<10));	/* by Matsuhashi */

	/* ウェイクアップ割り込み要因がクリアできないとき */
	if((i>=10) && (irqstatus_mpu & 0x00000001))	/* by Matsuhashi */
	{
		/* 割り込み要因のクリアをあきらめて割り込みをdisableにする */
		printk(KERN_ERR "\n\n@@@@@ [WARNING] @@@@@ prcm_irq_handler: WKUP_ST could not clear[retry=%d]\n\n", i);	/* by Matsuhashi */
		irqstatus_mpu = omap2_prm_read_mod_reg(OCP_MOD, OMAP3_PRM_IRQENABLE_MPU_OFFSET);/* by Matsuhashi */
		irqstatus_mpu &= ~0x00000001;							/* by Matsuhashi */
		omap2_prm_write_mod_reg(irqstatus_mpu, OCP_MOD,	OMAP3_PRM_IRQENABLE_MPU_OFFSET);/* by Matsuhashi */
	}
...
#ifdef CONFIG_MACH_TS990SUB
        /* 2013.04.17 Added by Matsuhashi */
        gpio_set_value(159, 0);
        printk(KERN_INFO "PM: APSHLT port set to [L]");
#endif
...
static int omap3_pm_suspend(void)
{
	...
	/* 2013.04.08 experimental added by Matsuhashi */
#if 1
	omap2_prm_write_mod_reg(OMAP3430_IO_EN_MASK | OMAP3430_WKUP_EN_MASK, OCP_MOD, OMAP3_PRM_IRQENABLE_MPU_OFFSET);
#else
	omap2_prm_write_mod_reg(OMAP3430_WKUP_EN_MASK, OCP_MOD, OMAP3_PRM_IRQENABLE_MPU_OFFSET);
#endif
...
static void __init prcm_setup_regs(void)
{
	...
	omap2_cm_write_mod_reg(1 << OMAP3430_AUTO_MPU_DPLL_SHIFT,
			 MPU_MOD,
			 CM_AUTOIDLE2);
#if 1	/* 2013.04.08 experimental added by Matsuhashi */
	...
	omap2_prm_write_mod_reg(OMAP3430_EN_IO_MASK | OMAP3430_EN_GPIO1_MASK |
        ...
        /* setup wakeup source, added by Matsuhashi */
        omap2_prm_write_mod_reg(OMAP3430_GRPSEL_UART2_MASK |
                          OMAP3430_GRPSEL_GPT1_MASK |
                          OMAP3430_GRPSEL_GPT12_MASK,
                          CORE_MOD, OMAP3430_PM_MPUGRPSEL);
...
#else
	/* 2013.04.09 experimental modified by Matsuhashi */
	omap2_prm_write_mod_reg(NULL, OMAP3430_PER_MOD, OMAP3430_PM_MPUGRPSEL);
#endif
